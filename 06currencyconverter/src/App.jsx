...
const convert= ()=>{
  ...
  return (
    ...
    style={{backgroundImage:'url(https://images.pexels.com/photos/210607/pexels-photo-210607.jpeg)'}}>
      <div className='w-full'>
        ...
        <form onSubmit={(e)=>{
          ...
          <div className='relative w-full h-0.5'>
            <button className='absolute left-1/2 -translate-x-1/2 -translate-y-1/2 border-
